...
const FOCUS_GUARD: React.CSSProperties = {
    clip: "rect(0px,0px,0px,0px)", overflow: "hidden", whiteSpace: "nowrap",
...
export default function UpdateProfileModal({
    ...
    useEffect(() => {
        if (open) { setShouldRender(true); setIsAnimatingOut(false); }
        else if (shouldRender) setIsAnimatingOut(true);
    ...
    const handleAnimationEnd = () => {
        if (isAnimatingOut) { setShouldRender(false); setIsAnimatingOut(false); }
    };
    ...
    return (
        <div id="_r_au_" data-base-ui-portal>
            {/* Overlay */}
            <div
                ...
                role="presentation" aria-hidden={true} style={{ userSelect: "none" }}
            />
            ...
            <div
                ...
                role="dialog" aria-modal="true" aria-labelledby="update-profile-title"
                tabIndex={-1} id="_r_5r_"
            >
                {/* Modal card */}
                <div
                ...
                >
                    <div className="flex flex-col w-full justify-between gap-3">
                        <div className="flex flex-col gap-8">
                            ...
                            {/* Header */}
                            <h1 id="update-profile-title" className="text-title-md">Cập nhật hồ sơ</h1>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    >
                                        {showAvatar
                                            ? <img src={avatarUrl.trim()} alt="Ảnh đại diện" className="w-full h-full object-cover" onError={() => setAvatarError(true)} />
                                            : <span className="text-primary font-medium" style={{ fontSize: 20, lineHeight: 1 }}>{avatarFallback}</span>
                                        }
                                    </div>
                                    {/* Name input */}
                                    <input
                                        id="profile-name" type="text" autoFocus
                                        placeholder="Tên hiển thị..." value={name} maxLength={255}
                                ...
                                {/* Avatar URL */}
                                <input
                                    id="profile-avatar" type="url"
                                    placeholder="URL ảnh đại diện (tuỳ chọn)" value={avatarUrl} maxLength={255}
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea
                                    id="profile-bio" rows={2}
                                    placeholder="Thêm mô tả về bạn..." value={bio} maxLength={500}
                            ...
                            >
                                {isSaving ? (
                                    <>
                                        ...
                                        <span className="font-medium text-sm">Đang lưu...</span>
                                    </>
                                ) : (
