...
export default function Panel({ isOpen = false, onClose }: PanelProps) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content wrapper */}
        <div className="flex flex-col flex-1 min-h-0" style={{ opacity: 1 }}>
          <div
            data-side-panel="true"
            className="relative h-full flex-1 min-h-0 flex-col gap-4 p-3 z-20 flex overflow-hidden text-primary"
          >
            <div className="flex h-full flex-1 flex-col gap-4 min-h-0">
                  ...
                  <div className="flex flex-1 flex-col gap-2 min-h-0">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <input
                        ...
                        className="flex-1 bg-transparent text-sm font-medium text-primary placeholder:text-secondary/60 outline-none border-b border-transparent focus:border-primary/30 transition-colors py-1"
                        type="text"
                    ...
                    <div className="flex flex-shrink-0 pt-2 border-t border-divider">
                      <div className="flex flex-1 flex-row flex-wrap gap-2">
                        <button
                          className="flex items-center justify-center gap-2 bg-clip-border focus-visible:outline-2 focus-visible:outline-current focus-visible:-outline-offset-2 border border-primary/[.13] shadow-sm enabled:hover:bg-state-hover enabled:active:bg-state-pressed backdrop-blur-glass text-subtitle-md px-3 h-8 flex-1 min-w-24 rounded-[20px] bg-state-enabled text-primary"
                          tabIndex={0}
                        >
