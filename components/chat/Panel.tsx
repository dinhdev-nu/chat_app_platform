    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0 relative overflow-hidden" style={{ opacity: 1 }}>
          {/* Design List View */}
          <div
            className={`absolute inset-0 transition-transform duration-300 ease-in-out z-10 flex flex-col ${
          ...
          {/* Theme Settings View */}
          <div
            className={`absolute inset-0 transition-transform duration-300 ease-in-out z-10 flex flex-col p-3 overflow-hidden text-primary ${
              activeView === "details" ? "translate-x-0" : "translate-x-full"
            }`}
          >
